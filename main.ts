...
let n0 = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nN = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nS = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nE = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nW = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nNW = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nNE = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nSE = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let nSW = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);

let bar = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);

let rho = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let ux = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let uy = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
let speed2 = new Float32Array(
  new ArrayBuffer(height * width * Float32Array.BYTES_PER_ELEMENT)
).fill(0);
...
const processWithWorkers = (): Promise<void> => {
